...
metadata2$Treatments <- factor(metadata2$Treatments, levels=c("no plant no amendment", "Control", "NPKS", "Straw+NPKS","PL", "PL/N",  "PLharvest","PLorig"))
...
# *Bacillus sp.* plot
## Sodosol 
### Kruskal test (holm adjusted) with LSD post-hoc test
```{r bacillusblot2, fig.cap = "Total read counts, relative abundances and clr transformed abundances of bacillus in Sodosol without plants and no amendments (control-P-A), with plants but no amendments (control-A), amended with NPKS, NPKS+straw (NPKS/straw), poultry litter (PL), poultry litter + N (PL/N). Letters represent significance of post hoc nonparametric tests (Kruskal-Wallis) at an alpha level of 0.05. Treatments with the same letter are not significantly different.", echo=FALSE, fig.width=11, fig.asp = 0.35, message=FALSE, warning=FALSE, cache=TRUE, eval=TRUE, include=TRUE}
#barplot
...
### Anova with Duncan multiple comparison test
```{r bacillusblot3, fig.cap = "Total read counts, relative abundances and clr transformed abundances of bacillus in Sodosol without plants and no amendments (control-P-A), with plants but no amendments (control-A), amended with NPKS, NPKS+straw (NPKS/straw), poultry litter (PL), poultry litter + N (PL/N). Letters represent significance of post hoc parametric tests (Duncan) at an alpha level of 0.05. Treatments with the same letter are not significantly different." , echo=FALSE, fig.width=11, fig.asp = 0.35, message=FALSE, warning=FALSE, cache=TRUE, eval=TRUE, include=TRUE}
#barplot
