...
bacilluscounts <- subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Total read counts" )  
...
bacillusrelative <- subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Relative abundances") 
...
bacillusclr <- subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Abundances clr transformed") 
...
subs <- physeqB.flt2.mlt.count %>% dplyr::filter(Genus %in% c("Bacillus")) 
bacilluscounts <- subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Total read counts" )  + scale_fill_manual(values = c("tomato","khaki4","mediumseagreen") )
...
subs <- physeqB.flt2.mlt.rel %>% dplyr::filter(Genus %in% c("Bacillus")) 
bacillusrelative <- subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Relative abundances")  + scale_fill_manual(values = c("tomato","khaki4","mediumseagreen") )
...
subs <- physeqB.flt2.mlt.clr %>% dplyr::filter(Genus %in% c("Bacillus")) 
bacillusclr <- subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Abundances clr transformed")  + scale_fill_manual(values = c("tomato","khaki4","mediumseagreen") )
