...
aldex_significant_features <- read.csv("~/Documents/Study/LaTrobe/Research/phD/Juan_project/aldex_NPKSvsPL_N/aldex_significant_features.csv")
...
```{r ancom, eval=TRUE, echo=FALSE, fig.width=9, fig.asp = 0.8, message=FALSE, warning=FALSE, cache=TRUE}
