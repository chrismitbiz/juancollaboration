...
# Bacillus sp. plot
## Both soils together
```{r bacillusblot, echo=FALSE, fig.width=8, fig.asp = 0.4, message=FALSE, warning=FALSE, cache=TRUE}
#barplot
...
## Sodosol only
```{r bacillusblot2, echo=FALSE, fig.width=8, fig.asp = 0.4, message=FALSE, warning=FALSE, cache=TRUE}
#barplot
...
## Vertisol only
```{r bacillusblot3, echo=FALSE, fig.width=8, fig.asp = 0.4, message=FALSE, warning=FALSE, cache=TRUE}
#barplot
