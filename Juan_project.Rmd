...
subs <- physeqB.flt2.mlt.clr %>% dplyr::filter(Genus %in% as.vector(aldex_significant_features$Genus) )
subs  %>% ggbarplot(data = ., x = "Genus", y = "Abundance", add = "mean_se", facet.by = c("Genus") , fill = "Treatments", width = 0.5, xlab = "", position = position_dodge(0.7), scales = "free", ylab = "Relative abundances") + ggtitle("Ancom")
```
